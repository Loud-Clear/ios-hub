...
//#import "DTAdditionalAsserts.h"

#import "DTObjectObserver.h"
#import "DTObjectObserver_Testable.h"
#import "DTMacroses.h"
...
@interface DTObjectObserverTests : XCTestCase


@end

@implementation DTObjectObserverTests
...
- (void)test_basic_observation
{
    ...
    DTObjectObserver *observer = [[DTObjectObserver alloc] initWithObject:objectToObserve observer:observerMock];
...
- (void)test_multiple_changes_one_call
{
    ...
    DTObjectObserver *observer = [[DTObjectObserver alloc] initWithObject:objectToObserve observer:nil];
